...
from ..utils.tabular_agents import (
...
class RolloutBuffer(BaseBuffer):
    """
    This is a modified variatn of the RolloutBuffer class from StableBaselines that
    includes the successor observations in the buffer.
...
def BufferWithMbValues(BaseBuffer):
    pass
